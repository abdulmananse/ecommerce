...
<head>
    ...
    <title> Goshop HTML Theme || Goshop Ecommerce Template</title>
        ...
        <div class="container theme-container">
            <div class="service">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="left">
                            <div class="icon"><img src="assets/img/extra/icon-money-back.png" alt="Money back"></div>
                        </div>
                ...
                <div class="row hvr2 spc-ofr">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="portfolio-wrapper">
                            ...
                            <div class="product-content">
                                <h3> <a class="title-3 fsz-16" href="#"> CICLYSMO JACKET </a> </h3>
                                <p class="font-3">Price: <span class="thm-clr"> $299.00 </span> <del> $599.00 </del> </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
