    ...
    <div class="site-main-footer container theme-container">
        ...
        <div class="post-footer">
            <div class="payment-systems text-center">
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-1.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-2.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-3.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-4.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-5.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-6.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-7.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-8.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-1.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-2.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-5.png') }}" alt=""></a> </div>
                <div class="item"> <a href="#"><img src="{{ asset('assets/img/extra/payment-3.png') }}" alt=""></a> </div>
